...
public class ImmutableNote extends AbstractNote{
    ...
    private final HashSet<String> bibliographies;
    ...
    @Override
    public HashSet<String> getTo() { return this.to; }

    @Override
    public HashSet<String> getFrom() { return this.from; }

    @Override
    public HashSet<String> getTags() { return this.tags; }

    @Override
    public HashSet<String> getBibliographies() { return this.bibliographies; }
    ...
    @Override
    public ImmutableNote getPreviousState() { return this; }

    @Override
    public boolean hasStepParent() { return this.stepParent != null; }
